...
for model_name in inference_model_names:
    ...
    model_base_path = os.path.join(
        "/home/sam/Documents/ESA/data/models/esr_gen/", model_name
    )
    ...
    dataset_preselect_sim_filepath = (
        "/home/sam/Documents/ESA/data/sim/xmm_demo_dataset/combined/20ks/img/1x"
    )
    dataset_preselect_sim_ref_filepath = (
        "/home/sam/Documents/ESA/data/sim/xmm_demo_dataset/combined/100ks/img/2x"
    )
    dataset_real = "TODO"
    ...
    if dataset_mode == "sim":
        ...
        if not os.path.exists(dataset_preselect_sim_ref_filepath):
            raise FileExistsError(
                f"No folder named {dataset_preselect_sim_ref_filepath}"
            )
