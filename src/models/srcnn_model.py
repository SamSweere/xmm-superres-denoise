...
class LitSRCNN(pl.LightningModule):
    ...
    def __init__(self, in_dims, out_dims, learning_rate):
        ...
        self.conv1 = nn.Conv2d(1, 32, kernel_size=9, padding=2,
                               padding_mode='replicate')  # padding mode same as original Caffe code
        self.conv2 = nn.Conv2d(32, 16, kernel_size=9, padding=2, padding_mode='replicate')
        self.conv3 = nn.Conv2d(16, 16, kernel_size=1, padding=4, padding_mode='replicate')
        self.conv4 = nn.Conv2d(16, 1, kernel_size=5, padding=2, padding_mode='replicate')
