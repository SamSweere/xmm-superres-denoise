...
def write_xmm_file_to_fits(img, output_dir, source_file_name, res_mult, exposure, comment=None, out_file_name=None,
                           in_header=None):
    header = fits.Header()
    ...
    if in_header is not None:
        header_keys_to_omit = ['SIMPLE', 'BITPIX', 'NAXIS', 'NAXIS1', 'NAXIS2', 'EXTEND', 'XPROC0', 'XDAL0', 'CREATOR',
                               'DATE',
                               'CTYPE1', 'CRPIX1', 'CRVAL1', 'CDELT1', 'CTYPE1L', 'CRPIX1L', 'CRVAL1L', 'CDELT1L',
                               'LTV1', 'LTM1_1',
                               'CTYPE2', 'CRPIX2', 'CRVAL2', 'CDELT2', 'CTYPE2L', 'CRPIX2L', 'CRVAL2L', 'CDELT2L',
                               'LTV2', 'LTM2_2',
                               'LTM1_2', 'LTM2_1',
                               'ONTIME01', 'ONTIME02', 'ONTIME03', 'ONTIME04', 'ONTIME05', 'ONTIME06', 'ONTIME07',
                               'ONTIME08', 'ONTIME09', 'ONTIME10', 'ONTIME11', 'ONTIME12',
                               'EXPOSURE', 'DURATION']
    ...
    header['COMMENT'] = f"Code Created by Sam Sweere (samsweere@gmail.com) for ESAC at " \
